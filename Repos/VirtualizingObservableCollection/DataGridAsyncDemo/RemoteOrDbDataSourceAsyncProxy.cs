...
namespace DataGridAsyncDemo
{
  ...
  public class RemoteOrDbDataSourceAsyncProxy
    : IPagedSourceProvider<RemoteOrDbDataItem>, IFilteredSortedSourceProviderAsync, INotifyCollectionChanged
  {
    #region fields
    ...
    public RemoteOrDbDataSourceAsyncProxy( RemoteOrDbDataSourceEmulation remoteDatas )
    {
      _remoteDatas = remoteDatas;
        this._remoteDatas.CollectionChanged += (sender, args) => this.CollectionChanged?.Invoke(this, args);
    }
