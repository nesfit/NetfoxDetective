    ...
    public static class DbContextExtensions
    {
        ...
        public static string GetTableName<T>(this ObjectContext context) where T : class
        {
            try
            {
                ...
                var method = typeof(ObjectContext).GetMethods()
                    .First(m => m.IsGenericMethod && m.Name == "CreateObjectSet");
        ...
        public static void Filter<TContext, TParentEntity, TCollectionEntity>(this TContext context,
            Expression<Func<TContext, IDbSet<TParentEntity>>> path,
            Expression<Func<TParentEntity, ICollection<TCollectionEntity>>> collection,
            Expression<Func<TCollectionEntity, Boolean>> filter)
