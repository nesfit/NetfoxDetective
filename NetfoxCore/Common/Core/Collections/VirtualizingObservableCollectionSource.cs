...
{
    public class VirtualizingObservableCollectionSource<T> : SynchronizedCollection<T>, IItemSourceProvider<T>,
        IEditableProvider<T>, IEditableProviderIndexBased<T>,
        IEditableProviderItemBased<T> where T : class
    {
        ...
        public class VirtualizingObservableCollectionSourceEnumerator<TT> : IEnumerator<TT> where TT : class
        {
            ...
            internal VirtualizingObservableCollectionSourceEnumerator(
                VirtualizingObservableCollectionSource<TT> sourceCollection)
            {
            ...
            public bool MoveNext()
            {
                ...
                {
                    if (this._sourceCollection.Count <= ++this._index)
                    {
                        return false;
                    }
