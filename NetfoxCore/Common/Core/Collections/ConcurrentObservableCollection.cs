...
{
    public class ConcurrentObservableCollection<T> : ObservableCollection<T>, INotifyCollectionChanged,
        INotifyPropertyChanged, IList<T>, IEnumerable<T>, ICollection<T>, ILoggable
    {
        ...
        {
            List<T> immutable;
            lock(this._lock) { immutable = base.Items.ToList(); }
