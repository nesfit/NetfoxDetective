...
namespace Netfox.Core.Models
{
    ...
    public class InvestigationInfo : IInvestigationInfo
    {
        ...
        public InvestigationInfo(INetfoxSettings settings, ILogger logger)
        {
        ...
        public FileInfo InvestigationFileInfo
        {
            get
            {
                ...
                this._investigationFileInfo = new FileInfo(Path.Combine(this.InvestigationDirectoryInfo.FullName,
                    this.InvestigationName + "." + _settings?.InvestigationFileExtension ?? DefaultNetfoxSettings.InvestigationFileExtension));
        ...
        public FileInfo DatabaseFileInfo
        {
            get
            {
                ...
                this._databaseFileInfo = this.DatabaseDirectoryInfo.GetSubFileInfo(this.InvestigationName + "." + _settings.DatabaseFileExtension);
