...
using EntityFramework.Utilities.Interfaces;
...
namespace EntityFramework.Utilities
{
        ...
        where TContext : DbContext
    {
        ...
        public static IEFBatchOperationBase<TTContext, TT> For<TTContext, TT>(TTContext context, IDbSet<TT> set)
            where TTContext : DbContext
            where TT : class
        {
            return new EFBatchOperation<TTContext, TT>(context, set);
        }
