...
namespace EntityFramework.Utilities
{
    class Fallbacks
    {
        internal static void DefaultInsertAll<T>(ObjectContext context, IEnumerable<T> items) where T : class
        {
            if (Configuration.DisableDefaultFallback)
            {
                throw new InvalidOperationException(
                    "No provider supporting the InsertAll operation for this datasource was found");
            }
        ...
        internal static int DefaultDelete<T>(ObjectContext context,
            System.Linq.Expressions.Expression<Func<T, bool>> predicate) where T : class
        {
            if (Configuration.DisableDefaultFallback)
            {
                throw new InvalidOperationException(
                    "No provider supporting the Delete operation for this datasource was found");
            }
        ...
        internal static int DefaultUpdate<T, TP>(ObjectContext context,
            System.Linq.Expressions.Expression<Func<T, bool>> predicate,
            System.Linq.Expressions.Expression<Func<T, TP>> prop,
            System.Linq.Expressions.Expression<Func<T, TP>> modifier) where T : class
        {
            if (Configuration.DisableDefaultFallback)
            {
                throw new InvalidOperationException(
                    "No provider supporting the Update operation for this datasource was found");
            }
