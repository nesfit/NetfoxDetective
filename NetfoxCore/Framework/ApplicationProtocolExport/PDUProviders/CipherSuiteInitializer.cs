...
namespace Netfox.Framework.ApplicationProtocolExport.PDUProviders
{
    ...
    {
        public static void PrepareDecryptingAlgorithms(String serverPk, ConversationCipherSuite cipherSuite,
            out KeyDecrypter keyDecrypter, out DataDecrypter dataDecrypter)
        {
