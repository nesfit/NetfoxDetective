...
using Netfox.Snoopers.SnooperHangouts.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperHangouts.Tests
{
    [TestFixture]
    public class SnooperHangoutsWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperHangoutsWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperHangoutsWindsorInstaller>
