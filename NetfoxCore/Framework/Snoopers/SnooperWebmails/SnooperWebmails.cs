...
using Netfox.Snoopers.SnooperWebmails.Models.Analyzers;
using Netfox.Snoopers.SnooperWebmails.Models.Spotters;
using Netfox.Snoopers.SnooperWebmails.Models.SpotterVisitors;
using Netfox.Snoopers.SnooperWebmails.Models.WebmailEvents;

namespace Netfox.Snoopers.SnooperWebmails
{
    public class SnooperWebmails : SnooperBase
    {
        ...
        public override SnooperExportBase PrototypeExportObject { get; } = new SnooperExportWebmail();
