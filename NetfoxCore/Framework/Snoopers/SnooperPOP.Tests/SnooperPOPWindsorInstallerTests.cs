...
using Netfox.Snoopers.SnooperPOP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperPOP.Tests
{
    [TestFixture]
    public class SnooperPOPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperPOPWindsorInstaller>
    {
