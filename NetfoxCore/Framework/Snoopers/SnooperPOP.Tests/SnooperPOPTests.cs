...
using Netfox.Snoopers.SnooperPOP.Models;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperPOP.Tests
{
    internal class SnooperPOPTests : SnooperBaseTests
    {
        ...
        public void POPTest_email_pop_smtp_1_filtered_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.email_pop_smtp_1_filtered_cap)));
