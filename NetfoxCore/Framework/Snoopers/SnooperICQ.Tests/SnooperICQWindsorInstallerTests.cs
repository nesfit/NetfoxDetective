...
using Netfox.Snoopers.SnooperICQ.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperICQ.Tests
{
    [TestFixture]
    public class SnooperICQWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperICQWindsorInstaller>
    {
