...
using Netfox.Snoopers.SnooperSMTP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperSMTP.Tests
{
    [TestFixture]
    public class SnooperSMTPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperSMTPWindsorInstaller>
    {
