...
namespace Netfox.Snoopers.SnooperSMTP.Tests
{
    internal class SnooperSMTPTests : SnooperBaseTests
    {
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.email_pop_smtp_1_cap)));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.m57_m57_smtp_1_pcap)));
        ...
        public void M57Case_smtp()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.m57_m57_smtp_pcap)));
