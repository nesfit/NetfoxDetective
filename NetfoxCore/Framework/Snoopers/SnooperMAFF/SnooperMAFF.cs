...
using Netfox.Snoopers.SnooperMAFF.Models.Parsers;

namespace Netfox.Snoopers.SnooperMAFF
{
    /// <summary>
    ...
    public class SnooperMAFF : SnooperBase
    {
        ...
        public override SnooperExportBase PrototypeExportObject { get; } = new SnooperExportMAFF();
