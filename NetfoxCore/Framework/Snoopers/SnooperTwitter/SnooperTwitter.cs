...
using Netfox.Snoopers.SnooperTwitter.Models;
using Netfox.Snoopers.SnooperTwitter.Models.Events;

namespace Netfox.Snoopers.SnooperTwitter
{
    public class SnooperTwitter : SnooperBase
    {
        ...
        public override SnooperExportBase PrototypeExportObject { get; } = new TwitterSnooperExport();
