...
using Netfox.Snoopers.SnooperIMAP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperIMAP.Tests
{
    [TestFixture]
    public class SnooperIMAPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperIMAPWindsorInstaller>
    {
