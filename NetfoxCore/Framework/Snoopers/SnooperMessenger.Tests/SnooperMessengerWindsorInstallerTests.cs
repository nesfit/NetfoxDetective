...
using Netfox.Snoopers.SnooperMessenger.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperMessenger.Tests
{
    [TestFixture]
    public class SnooperMessengerWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperMessengerWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperMessengerWindsorInstaller>
