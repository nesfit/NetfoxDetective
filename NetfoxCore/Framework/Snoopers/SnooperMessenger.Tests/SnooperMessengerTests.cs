...
using Netfox.Snoopers.SnooperMessenger.Models;
using Netfox.Snoopers.SnooperMessenger.Models.Events;
...
namespace Netfox.Snoopers.SnooperMessenger.Tests
{
    class SnooperMessengerTest : SnooperBaseTests
    {
        ...
        {
            var captureFile = this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.messenger_messenger2_pcapng));
            this.FrameworkController.ProcessCapture(captureFile);
