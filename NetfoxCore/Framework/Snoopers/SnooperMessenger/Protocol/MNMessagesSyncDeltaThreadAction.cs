...
namespace Netfox.Snoopers.SnooperMessenger.Protocol
{
  ...
  [Serializable]
  #endif
  public partial class MNMessagesSyncDeltaThreadAction : TBase
  {
    ...
    public MNMessagesSyncDeltaThreadAction() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("MNMessagesSyncDeltaThreadAction");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MNMessagesSyncDeltaThreadAction(");
      bool __first = true;
      if (ThreadKey != null && __isset.ThreadKey) {
