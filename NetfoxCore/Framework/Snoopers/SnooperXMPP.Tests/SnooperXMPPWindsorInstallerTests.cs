...
using Netfox.Snoopers.SnooperXMPP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperXMPP.Tests
{
    [TestFixture]
    public class SnooperXMPPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperXMPPWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperXMPPWindsorInstaller>
