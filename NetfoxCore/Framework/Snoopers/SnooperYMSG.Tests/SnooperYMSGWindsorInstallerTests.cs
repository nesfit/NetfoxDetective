...
using Netfox.Snoopers.SnooperYMSG.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperYMSG.Tests
{
    [TestFixture]
    public class SnooperYMSGWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperYMSGWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperYMSGWindsorInstaller>
