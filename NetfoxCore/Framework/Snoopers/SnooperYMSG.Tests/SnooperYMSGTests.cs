...
using Netfox.Snoopers.SnooperYMSG.Models;
...
namespace Netfox.Snoopers.SnooperYMSG.Tests
{
    public class SnooperYMSGTests : SnooperBaseTests
    {
        ...
        public void SnooperYMSGTest()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.pcap_mix_ymsg_without_file_cap)));
