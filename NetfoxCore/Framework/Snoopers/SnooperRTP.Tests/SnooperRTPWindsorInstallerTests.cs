...
using Netfox.Snoopers.SnooperRTP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperRTP.Tests
{
    [TestFixture]
    public class SnooperRTPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperRTPWindsorInstaller>
    {
