...
using Netfox.Snoopers.SnooperSPDY.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.Snoopers.SnooperSPDY.Tests
{
    [TestFixture]
    public class SnooperSPDYWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperSPDYWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperSPDYWindsorInstaller>
