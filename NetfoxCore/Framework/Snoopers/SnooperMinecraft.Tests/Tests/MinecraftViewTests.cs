...
using Netfox.Snoopers.SnooperMinecraft.WPF.Views;
using NUnit.Framework;
using MinecraftSnooperTestWindow = Netfox.Snoopers.SnooperMinecraft.WPF.Views.MinecraftSnooperTestWindow;
