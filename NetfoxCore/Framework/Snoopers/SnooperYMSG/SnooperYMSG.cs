...
using Netfox.Snoopers.SnooperYMSG.Enums;
using Netfox.Snoopers.SnooperYMSG.Models;

namespace Netfox.Snoopers.SnooperYMSG
{
    public class SnooperYMSG : SnooperBase
    {
        ...
        public override SnooperExportBase PrototypeExportObject { get; } = new SnooperExportYMSG();
