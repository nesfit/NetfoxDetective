...
{
    [TestFixture]
    public class SYNPacketsBaseTests : FeatureBaseTests<SYNPacketsBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 1.0d);
        }

        #region Overrides of FeatureBaseTests<SYNPacketsBase>
        ...
        {   
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 1.0d);
        }
