...
{
    [TestFixture]
    public class MeanInterArrivalTimeBaseTests : FeatureBaseTests<MeanInterArrivalTimeBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.9716805389139491d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.5854950000000001d);
        }

        #region Overrides of FeatureBaseTests<MeanInterArrivalTimeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.55424344444444451d);
