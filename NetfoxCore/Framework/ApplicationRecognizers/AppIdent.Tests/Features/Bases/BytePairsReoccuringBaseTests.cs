...
{
    [TestFixture]
    public class BytePairsReoccuringBaseTests : FeatureBaseTests<BytePairsReoccuringBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 2.0d);
        }
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 2.0d);
