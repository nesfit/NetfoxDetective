...
{
    [TestFixture]
    public class MedianInterArrivalTimeBaseTests : FeatureBaseTests<MedianInterArrivalTimeBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {  
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(4.0166436029689283d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.10928299999999999d);
        }

        #region Overrides of FeatureBaseTests<MedianInterArrivalTimeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.072025999999999993d);
