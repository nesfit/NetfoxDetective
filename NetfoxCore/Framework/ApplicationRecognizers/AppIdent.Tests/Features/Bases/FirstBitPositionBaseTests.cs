...
{
    [TestFixture]
    public class FirstBitPOsitionBaseTests : FeatureBaseTests<FirstBitPositionBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 1);
        }

        #region Overrides of FeatureBaseTests<FirstBitPositionBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 1);
        }
