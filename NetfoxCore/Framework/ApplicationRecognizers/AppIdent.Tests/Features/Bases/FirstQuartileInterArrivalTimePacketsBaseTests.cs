...
{
    [TestFixture]
    public class FirstQuartileInterArrivalTimePacketsBaseTests : FeatureBaseTests<FirstQuartileInterArrivalTimePacketsBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(43.458801498127919d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.0049829999999999996d
);
        }

        #region Overrides of FeatureBaseTests<FirstQuartileInterArrivalTimePacketsBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.0146445d);
        }
