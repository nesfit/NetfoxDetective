...
{
    [TestFixture]
    public class MeanInterArrivalTimePacketsBaseTests : FeatureBaseTests<MeanInterArrivalTimePacketsBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        { 
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(3.8322185104562148d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.38440111538461541d);
        }

        #region Overrides of FeatureBaseTests<MeanInterArrivalTimePacketsBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.30331693939393933d);
