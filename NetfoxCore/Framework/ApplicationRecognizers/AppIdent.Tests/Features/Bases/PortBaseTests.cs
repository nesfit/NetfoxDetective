...
{
    [TestFixture]
    public class PortBaseTests : FeatureBaseTests<Port>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 21253.0d);
           
        }

        #region Overrides of FeatureBaseTests<Port>
        ...
        {   
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 22.0d);
