...
{
    [TestFixture]
    public class ThirdQuartileInterArrivalTimeBaseTests : FeatureBaseTests<ThirdQuartileInterArrivalTimeBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {   
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(1.2506676036542506d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.42247999999999997d);
        }

        #region Overrides of FeatureBaseTests<ThirdQuartileInterArrivalTimeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.38920299999999997d);
        }
