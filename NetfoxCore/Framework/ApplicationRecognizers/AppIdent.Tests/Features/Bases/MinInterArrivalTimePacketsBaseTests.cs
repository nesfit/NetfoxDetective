...
{
    [TestFixture]
    public class MinInterArrivalTimePacketsBaseTests : FeatureBaseTests<MinInterArrivalTimePacketsBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {   
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(0.90000000000000036d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.0d);
        }

        #region Overrides of FeatureBaseTests<MinInterArrivalTimePacketsBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 1.7E-05d);
