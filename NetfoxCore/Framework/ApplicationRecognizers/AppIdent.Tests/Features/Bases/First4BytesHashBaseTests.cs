...
{
    [TestFixture]
    public class First4BytesHashBaseTests : FeatureBaseTests<First4BytesHashBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 70.75d);
        }

        #region Overrides of FeatureBaseTests<First4BytesHashBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 70.75d);
