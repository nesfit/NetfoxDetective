...
{
    [TestFixture]
    public class MeanControlBytesBaseTests : FeatureBaseTests<MeanControlBytesBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        { 
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.5413223140495371d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 20.307692307692307d);
        }

        #region Overrides of FeatureBaseTests<MeanControlBytesBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 20.242424242424242d);
