...
{
    [TestFixture]
    public class MaxInterArrivalTimePacketsBaseTests : FeatureBaseTests<MaxInterArrivalTimePacketsBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {    
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.7901010221770575d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 4.774025d);
        }

        #region Overrides of FeatureBaseTests<MaxInterArrivalTimePacketsBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 4.7084219999999997d);
