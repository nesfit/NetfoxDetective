...
namespace Netfox.AppIdent.Tests
{
        ...
        public class ApplicationRecognizerAppIDentTest : FrameworkBaseTests
        {
            ...
            {
                this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap)));
            ...
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_dnsHttpTls_cap), 0.3);
            }

            [Test]
            public void EPItest70()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_dnsHttpTls_cap), 0.7);
            }

            [Test]
            public void EPItest90()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_dnsHttpTls_cap), 0.9);
            }

            [Test]
            public void EPItest90M2()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap), 0.9);
            }
            ...
            public void BayesNetworkTest_M2()
            {
                ...
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap), 0.3);
                Console.WriteLine("\n##### Bayes Network with 70% threshold #####\n");
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap), 0.7);
                Console.WriteLine("\n##### Bayes Network with 90% threshold #####\n");
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap), 0.9);
            }
            ...
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test), 0.9);
            }

            [Test]
            public void MLtestipluskal_appIdent_test()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test), 0.9);
            }

            [Test]
            public void EPItestipluskal_appIdent_test1()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test1), 0.9);
            }

            [Test]
            public void MLtestipluskal_appIdent_test1()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test1), 0.9);
            }

            [Test]
            public void EPItestipluskal_appIdent_test2()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test2), 0.9);
            }

            [Test]
            public void MLtestipluskal_appIdent_test2()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent_test2), 0.9);
            }

            [Test]
            public void EPItestipluskal_appIdent1()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent1), 0.9);
            }

            [Test]
            public void MLtestipluskal_appIdent1()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.appIdent1), 0.9);
            }

            [Test]
            public void EPItestipluskal_pcr_20160415()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.pcr20160415), 0.9);
            }

            [Test]
            public void MLtestipluskal_pcr_20160415()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.pcr20160415), 0.9);
            }

            [Test]
            public void EPItestipluskal_pcr_20160416()
            {
                this.EpiTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.pcr20160416), 0.9);
            }

            [Test]
            public void MLtestipluskal_pcr_20160416()
            {
                this.MLTestCliBase(PcapPath.GetPcap(PcapPath.Pcaps.pcr20160416), 0.9);
            }
