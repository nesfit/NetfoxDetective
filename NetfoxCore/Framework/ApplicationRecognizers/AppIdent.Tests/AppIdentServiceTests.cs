...
namespace Netfox.AppIdent.Tests
{
    ...
    public class AppIdentServiceTests : FrameworkBaseTests
    {
        ...
        public void RandomForestsCrossValidationTest_LearnCompletelyDifferentPcap_fast()
        {
            ...
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_streamSkypeHttpTls_cap));
            ...
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_streamSkypeHttpTls_cap));
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_dnsHttpTls_cap));
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_learn1_cap));
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_refSkype_cap));
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM1_cap));
            this.ProcessPcapFile(PcapPath.GetPcap(PcapPath.Pcaps.app_identification_testM2_cap));
