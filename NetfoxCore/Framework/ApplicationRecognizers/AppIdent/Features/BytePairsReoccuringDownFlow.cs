...
{
    public class BytePairsReoccuringDownFlow : BytePairsReoccuringBase
    {
        public BytePairsReoccuringDownFlow() { }
        public BytePairsReoccuringDownFlow(L7Conversation l7Conversation) : base(l7Conversation, DaRFlowDirection.down) { }
        public BytePairsReoccuringDownFlow(double featureValue) : base(featureValue) { }
    }
}