...
{
    public class FirstQuartileControlBytesBase : FeatureBase
    {
        public FirstQuartileControlBytesBase() { }
        public FirstQuartileControlBytesBase(L7Conversation l7Conversation, DaRFlowDirection flowDirection) : base(l7Conversation, flowDirection) { }
        public FirstQuartileControlBytesBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            Array.Sort(bytes);
            return GetMedian(bytes.Take(medianIndex).ToArray());
        }
