...
{
    /*
     * Mean of L3 packet length
     */
    public class MeanPacketLengthBase : FeatureBase
    {
        public MeanPacketLengthBase() { }
        public MeanPacketLengthBase(L7Conversation l7Conversation, DaRFlowDirection flowDirection) : base(l7Conversation, flowDirection) { }
        public MeanPacketLengthBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            return pmFrameBases.Sum(frame => (frame.OriginalLengthWithoutPadding - (frame.L3Offset - frame.L2Offset))) / (double) pmFrameBases.Count();
        }
