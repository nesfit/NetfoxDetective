...
{
    /*
     * Maximal length of L3 packet
     */
    public class MaxPacketLengthBase : FeatureBase
    {
        public MaxPacketLengthBase() { }
        ...
        public MaxPacketLengthBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            return pmFrameBases.Max(frame => (frame.OriginalLengthWithoutPadding - (frame.L3Offset - frame.L2Offset)));
        }
