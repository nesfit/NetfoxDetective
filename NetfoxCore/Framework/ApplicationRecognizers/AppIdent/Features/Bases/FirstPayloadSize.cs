...
{
    public class FirstPayloadSize : FeatureBase
    {
        public FirstPayloadSize() { }

        public FirstPayloadSize(L7Conversation l7Conversation) : base(l7Conversation, DaRFlowDirection.non) { }
        ...
        public FirstPayloadSize(double featureValue) : base(featureValue) { }
        ...
        {
            var firstPdu = l7Conversation.L7PDUs.FirstOrDefault();

            if(firstPdu == null) { return -1; }

            return firstPdu.PDULength;
        }
