...
{
    public class MeanInterArrivalTimePacketsBase : FeatureBase
    {
        public MeanInterArrivalTimePacketsBase() { }
        ...
        public MeanInterArrivalTimePacketsBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            for(var i = 0; i < length - 1; i++) { tmpTime += (pmFrameBases[i + 1].FirstSeen - pmFrameBases[i].FirstSeen).TotalSeconds; }
