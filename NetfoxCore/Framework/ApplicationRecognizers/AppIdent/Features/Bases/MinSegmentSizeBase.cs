...
{
    public class MinSegmentSizeBase : FeatureBase
    {
        public MinSegmentSizeBase() { }
        public MinSegmentSizeBase(L7Conversation l7Conversation, DaRFlowDirection flowDirection) : base(l7Conversation, flowDirection) { }
        public MinSegmentSizeBase(double featureValue) : base(featureValue) { }
