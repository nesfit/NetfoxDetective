...
{
    public class NumberOfBytesBase : FeatureBase
    {
        public NumberOfBytesBase() { }
        public NumberOfBytesBase(L7Conversation l7Conversation, DaRFlowDirection flowDirection) : base(l7Conversation, flowDirection) { }
        public NumberOfBytesBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            return pmFrameBases.Sum(frame => frame.L7PayloadLength);
        }
