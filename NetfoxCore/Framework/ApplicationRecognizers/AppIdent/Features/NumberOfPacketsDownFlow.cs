...
{
    public class NumberOfPacketsDownFlow : NumberOfPacketsBase
    {
        public NumberOfPacketsDownFlow() { }
        public NumberOfPacketsDownFlow(L7Conversation l7Conversation) : base(l7Conversation, DaRFlowDirection.down) { }
        public NumberOfPacketsDownFlow(double featureValue) : base(featureValue) { }
    }
}