...
namespace Netfox.Framework.Models.Snoopers.Email
{
    ...
    public class MIMEemail : RawEMail, IEMail
    {
        ...
        public MIMEemail(SnooperExportEmailBase snooperExportBase, byte[] rawData, EMailContentType contentType) : base(
            snooperExportBase, rawData)
        {
        ...
        public void AddErrorReport(FcLogLevel level, string source, string description, string detail = null,
            Exception ex = null)
        {
            //Debugger.Break();
        ...
        private MIMEpart ParseMIMEpart(MIMEemail mimEemail, LineReader dataStream, MIMEpart parentPart,
            out bool finalPart)
        {
            ...
            if (currentPart.IsMultiPart)
            {
                ...
                currentPart.RawContent = this.ReadData(dataStream, currentPart.PartBoundary,
                    currentPart.ContentBoundary, currentPart.Encoding,
                    out isFinalPart);
            ...
            else
            {
                ...
                if (parentPart == null || parentPart.ContentBoundary == null)
                {
                    ...
                    currentPart.RawContent = currentPart.Encoding.GetString(
                        dataStream.ReadBytes((int) (dataStream.BaseStream.Length - dataStream.BaseStream.Position)));
                }
                else
                {
                    bool isDataFinalPart;
                    currentPart.RawContent = currentPart.RawContent = this.ReadData(dataStream, parentPart.PartBoundary,
                        parentPart.ContentBoundary, currentPart.Encoding,
                        out isDataFinalPart);
        ...
        public string ReadData(LineReader dataStream, string partBoundary, string contentBoundary, Encoding encoding,
            out bool isFinalPart)
        {
        ...
        public void ParseHeaders(LineReader dataStream, MIMEpart currentPart, MIMEpart parentPart, Encoding encoding,
            out bool boundaryFound)
        {
