...
namespace Netfox.Framework.Models
{
    ...
    public class L4Conversation : ILxConversation, IWindsorContainerChanger
    {
        ...
        public L4Conversation(IWindsorContainer container, IPProtocolType ipProtocol, L3Conversation l3Conversation,
        ...
        [DataMember] public Int64 L4FlowMTU { get; set; }

        public AddressFamily L3ProtocolType => this.SourceEndPoint?.AddressFamily ?? AddressFamily.Ipx;

        [DataMember] public IPProtocolType L4ProtocolType { get; set; }
        ...
        [DataMember] public Int32 DestinationEndPointPort { get; private set; }

        [DataMember, MaxLength(16)] public byte[] DestinationEndPointIPAddressData { get; private set; }

        [DataMember, MaxLength(16)] public byte[] SourceEndPointIPAddressData { get; private set; }

        [DataMember] public Int32 SourceEndPointPort { get; private set; }

        [NotMapped]
        public L4ConversationStatistics L4ConversationStatistics => this._l4ConversationStatistics ??
                                                                    (this._l4ConversationStatistics =
                                                                        new L4ConversationStatistics(
                                                                            this.UpConversationStatistic,
                                                                            this.DownConversationStatistic));

        public Guid? CaptureL4RefId { get; set; }
        [ForeignKey(nameof(CaptureL4RefId))] public CaptureL4 CaptureL4 { get; set; }
        ...
        public IPEndPoint DestinationEndPoint
        {
            get
            {
                return this._destinationEndPoint ?? (this._destinationEndPoint =
                    new IPEndPoint(new IPAddress(this.DestinationEndPointIPAddressData), this.DestinationEndPointPort));
            }
            set
            {
        ...
        public IPEndPoint SourceEndPoint
        {
            get
            {
                return this._sourceEndPoint ?? (this._sourceEndPoint =
                    new IPEndPoint(new IPAddress(this.SourceEndPointIPAddressData), this.SourceEndPointPort));
            }
            set
            {
        ...
        public IEnumerable<PmFrameBase> DownFlowFrames =>
            this.Frames.Where(f => this.DeterminFrameDirection(f) == DaRFlowDirection.down);
        ...
        public IEnumerable<PmFrameBase> UpFlowFrames =>
            this.Frames.Where(f => this.DeterminFrameDirection(f) == DaRFlowDirection.up);
        ...
        [NotMapped] [DoNotWire] public IWindsorContainer InvestigationWindsorContainer { get; set; }
        ...
        public override Int32 GetHashCode() =>
            (this.SourceEndPoint).GetHashCode() ^ (this.DestinationEndPoint).GetHashCode();
