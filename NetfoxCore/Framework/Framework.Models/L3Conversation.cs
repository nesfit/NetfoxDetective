...
namespace Netfox.Framework.Models
{
    ...
    public class L3Conversation : ILxConversation, IWindsorContainerChanger
    {
        ...
        [NotMapped] private ICollection<PmFrameBase> _nonL4Frames;
        ...
        public L3Conversation(IWindsorContainer container, IPAddress[] ipAddresses) : this(container, ipAddresses[0],
            ipAddresses[1])
        {
        }
        ...
        protected L3Conversation(IWindsorContainer container, L3Conversation conversationKey) : this(container,
            conversationKey.IPAddresses[0], conversationKey.IPAddresses[1])
        {
        }

        [DataMember] [MaxLength(16)] public byte[] IPAddress1Data { get; private set; }
        ...
        [DataMember] [MaxLength(16)] public byte[] IPAddress2Data { get; private set; }
        ...
        public ICollection<PmFrameBase> NonL4Frames
        {
            get
            {
                if (this._nonL4Frames != null)
                {
                    return this._nonL4Frames;
                }

                this._nonL4Frames = new List<PmFrameBase>(this.Frames.Where(f =>
                    !(f.IpProtocol == IPProtocolType.TCP || f.IpProtocol == IPProtocolType.UDP)));
                return this._nonL4Frames;
            }
        ...
        [IgnoreAutoChangeNotification] public IPEndPoint DestinationEndPoint => new IPEndPoint(this.IPAddress2, 0);

        [IgnoreAutoChangeNotification] public IPEndPoint SourceEndPoint => new IPEndPoint(this.IPAddress1, 0);
        ...
        [NotMapped] private ICollection<PmFrameBase> _frames;
        ...
        [NotMapped]
        public L3ConversationStatistics L3ConversationStatistics => this._l3ConversationStatistics ??
                                                                    (this._l3ConversationStatistics =
                                                                        new L3ConversationStatistics(
                                                                            this.UpConversationStatistic,
                                                                            this.DownConversationStatistic));

        #region Hash and Equals

        public override Int32 GetHashCode() => (this.IPAddresses[0] ?? NullEndPoint.Address).GetHashCode() ^
                                               (this.IPAddresses[1] ?? NullEndPoint.Address).GetHashCode();
