...
namespace Netfox.Framework.Models.PmLib.Frames
{
    ...
    public abstract class PmFrameBase  : IOrdereableEntity
    {
        ...
        protected PmFrameBase(PmCaptureBase pmCapture, PmLinkType pmLinkType, DateTime timeStamp, Int64 incLength,
            PmFrameType frameType, long frameIndex, long originalLength)
        {
        ...
        public virtual async Task IndexFrame(IPmCaptureProcessorBlockBase captureProcessorBlockBase)
        {
            ...
            catch (Exception ex) //TODO To general, it would be better to catch more and specific exceptions
            {
                ...
                PmConsolePrinter.PrintError("Cannot parse frame: " + (this.FrameIndex) + " in file: " +
                                            this.PmCapture.FileInfo.Name + ". It is marked as malformed!\n" +
                                            ex.Message);
            }
        }
        ...
        [NotMapped]
        public IPEndPoint DestinationEndPoint => this._destinationEndPoint ?? (this.DstAddress == null
            ? NullEndPoint
            : (this._destinationEndPoint = new IPEndPoint(this.DstAddress, this.DstPort)));
        ...
        public int L2L3L4HeaderSize =>
            (this.L7Offset != -1) ? (int) (this.L7Offset - this.L2Offset) : (int) this.OriginalLength;
        ...
        [NotMapped] [DataMember] public Byte[] L2DataEncapsulated { get; set; }
        ...
        [NotMapped]
        public IPEndPoint SourceEndPoint => this._sourceEndPoint ?? (this.SrcAddress == null
            ? NullEndPoint
            : (this._sourceEndPoint = new IPEndPoint(this.SrcAddress, this.SrcPort)));
        ...
        public Int32 MatchPattern(Byte[] haystack, Byte[] needle, Int32 start)
        {
            ...
            if (haystack.Length <= 0 || needle.Length <= 0 || start > (haystack.Length - needle.Length) ||
        ...
        [NonSerialized] private const Int16 UNINITIALIZED = -1;

        [NonSerialized] private const Byte RESERVED = 0;
// ReSharper restore InconsistentNaming
        ...
        [NotMapped] [DataMember] public Int32 WindowSizeScale { get; set; }
        ...
        {
            if (offsetInCaptureFile < this.L2Offset || this.L2Offset == -1)
            {
                return null;
            }
        ...
        [DataMember] public Guid PmCaptureRefId { get; private set; } = Guid.Empty;
        ...
        [MaxLength(16)] public byte[] DstAddressData { get; private set; } = {0, 0, 0, 0};
        ...
        [NotMapped] public bool IsDoneUpdateOffsetsForCaptureL4 { get; set; } = false;
        ...
        {
            return this.TimeStamp.GetHashCode() ^ this.FrameIndex.GetHashCode() ^ this.SrcAddressData.GetHashCode() ^
                   this.DstAddressData.GetHashCode();
        }
