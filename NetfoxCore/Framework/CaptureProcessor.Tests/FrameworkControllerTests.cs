...
namespace Netfox.Framework.Tests
{
    ...
    public abstract class FrameworkControllerTests : FrameworkBaseTests
    {
        ...
        {
            var captureFileInfo = this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.email_imap_smtp_pc2_pcap));
        ...
        {
            var captureFileInfo = this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.pcap_mix_all_export_mix_cap));
        ...
        {
            var captureFileInfo = this.PrepareCaptureForProcessing(PcapPath.GetPcap(PcapPath.Pcaps.pcap_mix_isa_http_pcap));
