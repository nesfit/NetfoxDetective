    ...
    public class ExportGroup : IWorkspaceObject, IEntity, INotifyPropertyChanged, IWindsorContainerChanger, ILoggable
    {
        ...
        public IObservableCollection Exports
        {
            get
            {
                ...
                {
                    var snooperExportsCollectionType =
                        typeof(VirtualizingObservableDBSetPagedCollection<>).MakeGenericType(
                            this.SnooperExportObjectType);
                    this._exports =
                        this.InvestigationWindsorContainer.Resolve(snooperExportsCollectionType) as
        ...
        public VirtualizingObservableDBSetPagedCollection<ExportGroup> ExportGroups
        {
            get
            {
                if (this._exportGroups == null)
                {
                    ...
                    this._exportGroups =
                        new VirtualizingObservableDBSetPagedCollection<ExportGroup>(this.InvestigationWindsorContainer,
                            dbx, func);
                }
        ...
        public Type SnooperExportObjectType
        {
            get
            {
                if (this._snooperExportObjectType != null)
                {
        ...
        [NotMapped] public InvestigationInfo Workspace { get; set; }
