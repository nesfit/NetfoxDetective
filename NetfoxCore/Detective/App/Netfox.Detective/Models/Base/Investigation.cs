...
namespace Netfox.Detective.Models.Base
{
    ...
    public class Investigation : IInvestigation
    {
        ...
        public IObservableCollection<PmCaptureBase> Captures
            => this._captures ?? (this._captures = this.InvestigationWindsorContainer
                .Resolve<VirtualizingObservableDBSetPagedCollection<PmCaptureBase>>());

        [DataMember] public IInvestigationInfo InvestigationInfo { get; }
        ...
        public IObservableCollection<ConversationsGroup> ConversationsGroups
            =>
                ...
                ?? (this._conversationsGroups = this.InvestigationWindsorContainer
        ...
        public IObservableCollection<ExportGroup> ExportsGroups
            => this._exportsGroups ?? (this._exportsGroups = this.InvestigationWindsorContainer
                .Resolve<VirtualizingObservableDBSetPagedCollection<ExportGroup>>());

        [NotMapped]
        [IgnoreAutoChangeNotification]
        public IObservableCollection<PmFrameBase> AllFrames
            => this._allFrames ?? (this._allFrames = this.InvestigationWindsorContainer
        ...
        public IObservableCollection<SourceLog.SourceLog> SourceLogs
            => this._sourceLogs ?? (this._sourceLogs = this.InvestigationWindsorContainer
                .Resolve<VirtualizingObservableDBSetPagedCollection<SourceLog.SourceLog>>());

        [NotMapped]
        [IgnoreAutoChangeNotification]
        public IObservableCollection<PmFrameBase> Frames
            => this._frames ?? (this._frames = this.InvestigationWindsorContainer
                .Resolve<VirtualizingObservableDBSetPagedCollection<PmFrameBase>>());

        [NotMapped]
        [IgnoreAutoChangeNotification]
        public IObservableCollection<L3Conversation> L3Conversations
            => this._l3Conversations ?? (this._l3Conversations = this.InvestigationWindsorContainer
        ...
        public IObservableCollection<L4Conversation> L4Conversations
            => this._l4Conversations ?? (this._l4Conversations = this.InvestigationWindsorContainer
        ...
        public IObservableCollection<L7Conversation> L7Conversations
            => this._l7Conversations ?? (this._l7Conversations = this.InvestigationWindsorContainer
        ...
        public IObservableCollection<SnooperExportBase> SnooperExports
            => this._snooperExports ?? (this._snooperExports = this.InvestigationWindsorContainer
        ...
        public async Task Initialize()
        {
            await Task.Run(() =>
            {
                ...
                this._captures = this.InvestigationWindsorContainer
                    .Resolve<VirtualizingObservableDBSetPagedCollection<PmCaptureBase>>();
            });
        }
        ...
        {
            this.InvestigationWindsorContainer.Register(Component.For<SqlConnectionStringBuilder>()
                .Instance(this.InvestigationInfo.SqlConnectionStringBuilder).LifestyleSingleton());
            if (this.InvestigationInfo.IsInMemory)
            {
                this.InvestigationWindsorContainer.Register(Component.For<NetfoxDbContext, NetfoxDbContextInMemory>()
                    .LifestyleSingleton());
                this.InvestigationWindsorContainer.Register(
                    Component.For<IObservableNetfoxDBContext>().ImplementedBy<NetfoxDbContextInMemory>()
                        .Named(nameof(IObservableNetfoxDBContext)).LifestyleSingleton());
            }
            else
            {
                this.InvestigationWindsorContainer.Register(Component.For<NetfoxDbContext>()
                    .ImplementedBy<NetfoxDbContext>().LifestyleTransient());
                this.InvestigationWindsorContainer.Register(
                    Component.For<IObservableNetfoxDBContext>().ImplementedBy<NetfoxDbContext>()
                        .Named(nameof(IObservableNetfoxDBContext)).LifestyleSingleton());
            }
