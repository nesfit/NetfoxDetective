...
namespace Netfox.Detective.Interfaces.Models.Base
{
    public interface IInvestigation : IConversationsModel, IWindsorContainerChanger, INotifyPropertyChanged, IInitializable
    {
        ...
        [DataMember] IInvestigationInfo InvestigationInfo { get; }

        [NotMapped] ConcurrentIObservableVirtualizingObservableCollection<OperationLog> OperationLogs { get; set; }
        ...
        [NotMapped] IWindsorContainer InvestigationWindsorContainer { get; set; }
    }
}