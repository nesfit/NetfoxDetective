    ...
    public class NetfoxWebMapping : IMapping
    {
        public void Configure(IMapperConfigurationExpression mapper)
        {
            ...
            mapper.CreateMap<ConvesationStatisticsDTO, CaptureStats>()
                ...
                .ForMember(c => c.ExportedProtocols, m => m.MapFrom(s => s.ExportedProtocols == null ? null : JsonConvert.SerializeObject(s.ExportedProtocols)))
            ...
            mapper.CreateMap<CaptureStats, CaptureDTO>();
            
            mapper.CreateMap<ExportStats, ExportStatisticsDTO>();
            mapper.CreateMap<ExportStatisticsDTO, ExportStats>()
                .ForMember(c => c.Id, m => m.Ignore());
        }
    }
}