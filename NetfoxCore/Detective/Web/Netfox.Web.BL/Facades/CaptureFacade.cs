...
namespace Netfox.Web.BL.Facades
{
    public class CaptureFacade : NetfoxFacadeBase
    {
        ...
        public CaptureFacade(INetfoxWebSettings settings, NetfoxUnitOfWorkProvider uowProvider, NetfoxRepositoryProvider repositoryProvider, StatsFacade stats, InvestigationInfo investigationInfo) : base(uowProvider, repositoryProvider)
        {
            _settings = settings;
            this.Stats = stats;
