...
namespace Netfox.Detective.ViewModelsDataEntity
{
    ...
    {
        protected DetectiveIvestigationDataEntityPaneViewModelBase(IWindsorContainer applicationWindsorContainer, object model) : base(applicationWindsorContainer)
        {
