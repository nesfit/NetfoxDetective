...
namespace Netfox.Detective.ViewModelsDataEntity.BkTasks
{
    ...
    public class BgTaskVm : DetectiveDataEntityViewModelBase, IBgTask
    {
        ...
        public RelayCommand CAbortTask => this._cAbortTask ?? (this._cAbortTask = new RelayCommand(this.Abort, () => this.State == TaskState.Running));
        ...
        public void UpdateDuration() { this.Duration = DateTime.Now - this.StartTimeStamp; }
        #endregion
