...
namespace Netfox.Detective.Views.Converters
{
    public class IPProtocolTypeToColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            //if(conv == null || conv.Statistics == null) { return new SolidColorBrush(Colors.Black); }
            //if(protocolType == null) { return new SolidColorBrush(Colors.Black); }

            // if(conv.Statistics.MissingBytes > 0 || conv.Statistics.MissingFrames > 0) { return new SolidColorBrush(Colors.White); }
            //case "UDP":
