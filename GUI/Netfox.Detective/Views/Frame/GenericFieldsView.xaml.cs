    ...
    public partial class GenericFieldsView : PacketViewBase
    {
        ...
        public void ExpandNode(ItemsControl control, string id)
        {
            if(control != null)
            {
                ...
                {
                    var viewModel = control.Items[i] as FrameVm.GenericFiledVm;
        ...
        {
            var fieldVm = this.TreeView.SelectedItem as FrameVm.GenericFiledVm;
            if(fieldVm != null)
            {
        ...
        private void treeViewCollapsed(object sender, RadRoutedEventArgs e)
        {
            ...
            var collapsedItem = treeViewItem.Item as FrameVm.GenericFiledVm;
        ...
        private void treeViewExpanded(object sender, RadRoutedEventArgs e)
        {
            ...
            var expandedItem = treeViewItem.Item as FrameVm.GenericFiledVm;
