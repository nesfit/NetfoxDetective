...
namespace Netfox.Detective.ViewModels.Investigations
{
    ...
    public class InvestigationsManagerVm : DetectiveApplicationPaneViewModelBase
    {
        ...
        private readonly ISerializationPersistor<Investigation> _investigatSerializationPersistor;
        #region Constructor
        ...
        private void ExitedApplicationMessageReceived(ExitedApplicationMessage msg) { this.SaveInvestigations(); }

        private void SaveInvestigations()
        {
            foreach (var investigation in InnerInvestigations)
            {
                this._investigatSerializationPersistor.Save(investigation);
            }
        }
        ...
        public ViewModelVirtualizingIoCObservableCollection<InvestigationVm, Investigation> Investigations
        {
            get
            {
                ...
                {
                    this._investigations = new ViewModelVirtualizingIoCObservableCollection<InvestigationVm, Investigation>(this.InnerInvestigations, this.ApplicationOrInvestigationWindsorContainer);
        ...
        {
            get { return this._innerInvestigations ?? (this._innerInvestigations = new ConcurrentIObservableVirtualizingObservableCollection<Investigation>()); }
            ...
            set
            {
                ...
                { 
                    this._currentInvestigation = this.Investigations.FirstOrDefault();
                        ...
                        this._messenger.AsyncSend(new OpenedInvestigationMessage { InvestigationVm = this._currentInvestigation });
                        return;
                }
        ...
        [IgnoreAutoChangeNotification]
        public RelayCommand CNewToCreateInvestigation => this._CNewToCreateInvestigation ?? (this._CNewToCreateInvestigation =
                                                             new RelayCommand(
                                                                 () => this.NavigationService.Show(typeof(NewWorkspaceInvestigationWizardVm), this.Workspace),
                                                                 () => this.Workspace != null));
        ...
        public ICommand COpenWorkspaceFolder => new RelayCommand(() =>
        {
            ...
            {
                Process.Start(this.Workspace?.WorkspaceDirectoryInfo.FullName);
            }
        });
        ...
        private void CleanInvestigations()
        {
            ...
            this.Investigations =
                new ViewModelVirtualizingIoCObservableCollection<InvestigationVm, Investigation>(this.InnerInvestigations, this.ApplicationOrInvestigationWindsorContainer);
        }
        public async Task LoadInvestigations(Workspace workspace)
        {
            ...
            {
                var investigationFileInfo = this._fileSystem.FileInfo.FromFileName(Path.Combine(this.WorkspaceInvestigationsDIrectoryInfo().FullName, investigationFilePath));
        ...
        {
            return new DirectoryInfoFactory(this._fileSystem).CreateInvestigationsDirectoryInfo(this.Workspace.WorkspaceDirectoryInfo);
        }
        ...
        public void RemoveInvestigation(IInvestigationVm investigation)
        {
            ...
            this.Workspace.InvestigationsFilePaths.Remove(investigation.Investigation.InvestigationInfo.InvestigationFileRelativePath);
        ...
        public ICommand COpenInvestigationFolder => new RelayCommand(() =>
        {
            ...
            {
                Process.Start(investigation.InvestigationInfo.InvestigationDirectoryInfo.FullName);
            }
        });
        #endregion
        #endregion
