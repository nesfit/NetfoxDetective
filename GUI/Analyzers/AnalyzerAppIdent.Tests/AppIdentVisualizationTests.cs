...
namespace Netfox.AnalyzerAppIdent.Tests
{
    ...
    public class AppIdentVisualizationTests : ApplicationRecognizerAppIDentTest
    {
        ...
        public void EPItest30_1() {
            this.EpiVisualizationBase(Pcaps.Default.app_identification_dnsHttpTls_cap, 0.3);
        }
        [Test]
        public void MLtest30_1()
        {
            this.MLVisualizationBase(Pcaps.Default.app_identification_dnsHttpTls_cap, 0.3);
        }
        [Test]
        [Explicit]
        [Category("Explicit")]
        ...
        {
            this.EpiMLVisualizationBase(Pcaps.Default.app_identification_dnsHttpTls_cap, 0.3, 0.99);
        }
