...
using IDirectoryInfoFactory = Netfox.Detective.Infrastructure.IDirectoryInfoFactory;
...
namespace Netfox.Detective.Tests.Infrastructure
{
    ...
    public class DirectoryInfoFactoryTests
    {
        ...
        {
            // arrange & act & assert
            Assert.Throws<ArgumentNullException>(() => this._directoryInfoFactory.CreateSubdirectoryInfo(this._mockedFileSystem.DirectoryInfo.FromDirectoryName("someDirectoryName"), null));
