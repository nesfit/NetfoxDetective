...
namespace Netfox.Framework.ApplicationProtocolExport.PDUProviders
{
    ...
    internal abstract class DataDecrypter
    {
        ...
        public void DecreaseClientSeq() { this._clientSeq--; }

        public void DecreaseServerSeq() { this._serverSeq--; }
    ...
    class AesDecrypter : DataDecrypter
    {
        ...
        public override Byte[] DecryptData(Byte[] cipheredData, PDUDecrypter.WriteKeySpec keySpec)
        {
            ...
            {
                case CipherMode.Cbc:
                    if(keySpec == PDUDecrypter.WriteKeySpec.Client) { return this.Decrypt(this.Ccipher, cipheredData); }
                    return this.Decrypt(this.Scipher, cipheredData);
                case CipherMode.Ccm:
                case CipherMode.Gcm:
                    if(keySpec == PDUDecrypter.WriteKeySpec.Client) { return this.Decrypt(this.CaeadCipher, cipheredData); }
    ...
    class Rc4Decrypter : DataDecrypter
    {
        ...
        public override Byte[] DecryptData(Byte[] cipheredData, PDUDecrypter.WriteKeySpec keySpec)
        {
            if(keySpec == PDUDecrypter.WriteKeySpec.Client) { return this.Decrypt(this.CStreamCipher, cipheredData); }
