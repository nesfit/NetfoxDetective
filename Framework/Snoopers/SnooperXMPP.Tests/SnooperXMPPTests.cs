...
using Netfox.SnooperXMPP.Models;
...
namespace Netfox.SnooperXMPP.Tests
{
    internal class SnooperXMPPTests : SnooperBaseTests
    {
        ...
        public void SnooperXMPPTest()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.pcap_mix_xmpp_nosecure_cap));
