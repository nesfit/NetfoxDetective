...
namespace Netfox.SnooperMinecraft.Tests
{
    internal class SnooperMinecraftTestsSpecificPort : SnooperBaseTests
    {
        ...
        public void MinecraftTest_minecraft_xberan33_07_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.minecraft_xberan33_minecraft_at_port_41030_pcap));
        ...
        public void MinecraftTest_minecraft_xberan33_08_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.minecraft_xberan33_minecraft_at_port_27746_pcap));
        ...
        public void MinecraftTest_minecraft_xberan33_09_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.minecraft_xberan33_minecraft_at_port_27999_pcap));
        ...
        public void MinecraftTest_minecraft_xberan33_10_via_FrameworkController2()
        {
            ...
            // mainly normal chat
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.minecraft_xberan33_minecraft_at_port_37892_pcap));
