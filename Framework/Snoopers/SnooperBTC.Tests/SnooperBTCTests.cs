...
namespace Netfox.SnooperBTC.Tests
{
    internal class SnooperBTCTests : SnooperBaseTests
    {
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.bitcoin_btc2_part1_pcapng));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.bitcoin_btc2_part2_pcapng));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.bitcoin_btc2_pcapng));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.bitcoin_btc2_snapshot_pcapng));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.bitcoin_btc2_tx_01_pcapng));
