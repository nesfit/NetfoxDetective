...
namespace Netfox.SnooperMessenger.Protocol
{
  ...
  [Serializable]
  #endif
  public partial class MNMessagesSyncDeltaThreadDelete : TBase
  {
    ...
    public MNMessagesSyncDeltaThreadDelete() {
    }
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    MNMessagesSyncThreadKey _elem61;
                    _elem61 = new MNMessagesSyncThreadKey();
                    _elem61.Read(iprot);
                    ThreadKeys.Add(_elem61);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("MNMessagesSyncDeltaThreadDelete");
        ...
        if (ThreadKeys != null && __isset.ThreadKeys) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (MNMessagesSyncThreadKey _iter62 in ThreadKeys)
            {
              _iter62.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MNMessagesSyncDeltaThreadDelete(");
      bool __first = true;
      if (ThreadKeys != null && __isset.ThreadKeys) {
