...
namespace Netfox.SnooperXchat.Tests
{
    ...
    public class SnooperXchatTests : SnooperBaseTests
    {
        ...
        {
            this.SnoopersToUse = new List<ISnooper> { new Netfox.SnooperHTTP.SnooperHTTP(), new SnooperXchat() };
        }
        [Test]
        public void Test_Xchat_private_messages()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.xchat_xchat_chat_pcapng));
        ...
        public void Test_Xchat_room_messages()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.xchat_xchat_room_chat_pcapng));
            var conversations = this.L7Conversations.ToArray();

            this.FrameworkController.ExportData(new List<ISnooper> { new Netfox.SnooperHTTP.SnooperHTTP() }, conversations, this.CurrentTestBaseDirectory, true);
