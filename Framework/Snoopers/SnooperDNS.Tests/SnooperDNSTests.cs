    ...
    internal class SnooperDNSTests : SnooperBaseTests
    {
        ...
        public void DNSTest_responseA_xvican01_via_FrameworkController2()
        {
            ...
            var messages = new string[]
            {
                ...
                "[]",
                "[{\"IPAddress\":{\"AddressData\":\"RQTs7w==\",\"ScopeId\":2,\"Address\":0,\"AddressFamily\":2,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":3600,\"Name\":\"stun.softjoys.com\",\"QType\":1,\"QClass\":1}]"
            };

            this.CheckQueryAndAnswer(messageID, flags, messages, DNSParseMsg.DNSResponseType.ANSWER, SnoopersPcaps.Default.dns_dns_xvican01_01_pcap);
        }
        ...
        public void DNSTest_responseAAAA_xvican01_via_FrameworkController2()
        {
            ...
            var messages = new string[]
            {
                ...
                "[]",
                "[{\"IPAddress\":{\"AddressData\":\"IAEGfBIgCAkAAAAAk+UJFw==\",\"ScopeId\":23,\"Address\":0,\"AddressFamily\":23,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":9914,\"Name\":\"www.fit.vutbr.cz\",\"QType\":28,\"QClass\":1}]"
            };

            this.CheckQueryAndAnswer(messageID, flags, messages, DNSParseMsg.DNSResponseType.ANSWER, SnoopersPcaps.Default.dns_dns_xvican01_02_pcap);
        }
        ...
        public void DNSTest_responseOther_xvican01_via_FrameworkController2()
        {
            ...
            var messages = new string[]
            {
                ...
                "[]",
                "[{\"IPAddress\":{\"AddressData\":\"QKpiHg==\",\"ScopeId\":2,\"Address\":0,\"AddressFamily\":2,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":1240,\"Name\":\"www.ietf.org\",\"QType\":1,\"QClass\":1},{\"DataBytes\":\"\",\"TTL\":1240,\"Name\":\"www.ietf.org\",\"QType\":46,\"QClass\":1}]"
            };

            this.CheckQueryAndAnswer(messageID, flags, messages, DNSParseMsg.DNSResponseType.ANSWER, SnoopersPcaps.Default.dns_dns_sec_pcap);
        }
        ...
        public void DNSTest_tcp_xvican01_via_FrameworkController2()
        {
            ...
            var messages = new string[]
            {
                ...
                "[]",
                "[{\"IPAddress\":{\"AddressData\":\"w3GQzQ==\",\"ScopeId\":2,\"Address\":0,\"AddressFamily\":2,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":41073,\"Name\":\"nsa.ces.net\",\"QType\":1,\"QClass\":1},{\"IPAddress\":{\"AddressData\":\"IAEHGAABAAEAAAAAAUQCBQ==\",\"ScopeId\":23,\"Address\":0,\"AddressFamily\":23,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":41073,\"Name\":\"nsa.ces.net\",\"QType\":28,\"QClass\":1},{\"IPAddress\":{\"AddressData\":\"w3GQ5A==\",\"ScopeId\":2,\"Address\":0,\"AddressFamily\":2,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":2438,\"Name\":\"nsa.cesnet.cz\",\"QType\":1,\"QClass\":1},{\"IPAddress\":{\"AddressData\":\"IAEHGAABAQEAAAAAAUQCKA==\",\"ScopeId\":23,\"Address\":0,\"AddressFamily\":23,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":2438,\"Name\":\"nsa.cesnet.cz\",\"QType\":28,\"QClass\":1},{\"IPAddress\":{\"AddressData\":\"nsSVCQ==\",\"ScopeId\":2,\"Address\":0,\"AddressFamily\":2,\"IsIPv6Multicast\":false,\"IsIPv6LinkLocal\":false,\"IsIPv6SiteLocal\":false,\"IsIPv6Teredo\":false,\"IsIPv4MappedToIPv6\":false},\"TTL\":2200,\"Name\":\"decsys.vsb.cz\",\"QType\":1,\"QClass\":1}]"
            };

            this.CheckQueryAndAnswer(messageID, flags, messages, DNSParseMsg.DNSResponseType.ADDITIONAL, SnoopersPcaps.Default.dns_dns_xvican01_03_pcap);
        }
        ...
        public void DNSTest_mix1_xvican01_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.dns_dns_xvican01_01_pcap));
            var conversations = this.L7Conversations.ToArray();
            this.FrameworkController.ExportData(this.SnoopersToUse, conversations, this.CurrentTestBaseDirectory, true);
        ...
        public void DNSTest_mix2_xvican01_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.dns_dns_xvican01_03_pcap));
            var conversations = this.L7Conversations.ToArray();
            this.FrameworkController.ExportData(this.SnoopersToUse, conversations, this.CurrentTestBaseDirectory, true);
