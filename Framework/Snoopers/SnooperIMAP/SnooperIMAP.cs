...
using Netfox.SnooperIMAP.Models;

namespace Netfox.SnooperIMAP
{
    public class SnooperIMAP : SnooperBase
    {
        ...
        public override SnooperExportBase PrototypExportObject => new SnooperExportIMAP(this.ExportBaseDirectory);
