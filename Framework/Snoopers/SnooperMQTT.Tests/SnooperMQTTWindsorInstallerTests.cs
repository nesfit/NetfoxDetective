...
using Netfox.SnooperMQTT.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.SnooperMQTT.Tests
{
    [TestFixture]
    public class SnooperMQTTWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperMQTTWindsorInstaller>
    {
        #region Overrides of WindsorInvestigationInstallerTestsBase<SnooperMQTTWindsorInstaller>
