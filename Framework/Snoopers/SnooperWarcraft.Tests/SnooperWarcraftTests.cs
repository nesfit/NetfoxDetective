...
using Netfox.SnooperWarcraft.Models;
...
namespace Netfox.SnooperWarcraft.Tests
{
    internal class SnooperWarcraftTests : SnooperBaseTests
    {
        ...
        public void WarcraftTest_warcraft_xberan33_02_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_2_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_03_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_3_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_06_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_guild_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_07_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_instance_leader_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_08_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_instance_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_09_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_party_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_10_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_party_leader_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_11_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_raid_leader_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_12_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_raid_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_13_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_raid_warning_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_14_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_say_yell_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
        ...
        public void WarcraftTest_warcraft_xberan33_15_via_FrameworkController2()
        {
            var infos = new List<FileInfo>
            {
                this.PrepareCaptureForProcessing(SnoopersPcaps.Default.warcraft_xberan33_whisper_wdat)
            };
            this.FrameworkController.ExportData(this.AvailableSnoopers, infos, this.CurrentTestBaseDirectory);
