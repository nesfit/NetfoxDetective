...
namespace Netfox.SnooperHTTP.WEB.Facade
{
    public class ExportHTTPFacade : NetfoxFacadeBase
    {
        ...
        public ExportHTTPFacade(NetfoxUnitOfWorkProvider unitOfWorkProvider, NetfoxRepositoryProvider repositoryProvider) : base(unitOfWorkProvider, repositoryProvider) { }

        public void FillMessages(Guid investigationId, GridViewDataSet<SnooperHTTPListDTO> dataset, ExportFilterDTO filter)
        {
