...
namespace Netfox.SnooperFTP.Tests
{
    internal class SnooperFTPTests : SnooperBaseTests
    {
        ...
        public void FTPTest_ftp_xkarpi03_01_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_01_pcap));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_02_pcap));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_03_upload_pcap));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_04_delete_pcap));
        ...
        public void FTPTest_ftp_xkarpi03_05_download_via_FrameworkController2()
        {
            ...
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_05_download_pcap));
        ...
        {
            this.FrameworkController.ProcessCapture(this.PrepareCaptureForProcessing(SnoopersPcaps.Default.ftp_ftp_xkarpi03_06_text_upload_pcap));
