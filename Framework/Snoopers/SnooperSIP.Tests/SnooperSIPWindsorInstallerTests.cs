...
using Netfox.SnooperSIP.WPF.Infrastructure;
using NUnit.Framework;

namespace Netfox.SnooperSIP.Tests
{
    [TestFixture]
    public class SnooperSIPWindsorInstallerTests : WindsorInvestigationInstallerTestsBase<SnooperSIPWindsorInstaller>
    {
