...
{
    internal class L7ConversationTrackerBlock : ITargetBlock<PmFrameBase>, ITargetBlock<L4ConversationExtended>, ISourceBlock<L7Conversation>, ISourceBlock<PmFrameBase>,
        ISourceBlock<L4Conversation>, ISourceBlock<L7PDU>, ISourceBlock<L7ConversationStatistics>, ISourceBlock<PmCaptureL7Conversation>
    {
        ...
        private ISourceBlock<PmCaptureL7Conversation> _PmCaptureL7Conversations => this.PmCaptureL7Conversations;
        ...
        #region Implementation of ISourceBlock<out PmCaptureL7Conversation>
        public IDisposable LinkTo(ITargetBlock<PmCaptureL7Conversation> target, DataflowLinkOptions linkOptions) { return this._PmCaptureL7Conversations.LinkTo(target, linkOptions); }
        public PmCaptureL7Conversation ConsumeMessage(DataflowMessageHeader messageHeader, ITargetBlock<PmCaptureL7Conversation> target, out bool messageConsumed) { return this._PmCaptureL7Conversations.ConsumeMessage(messageHeader, target, out messageConsumed); }
        public bool ReserveMessage(DataflowMessageHeader messageHeader, ITargetBlock<PmCaptureL7Conversation> target) { return this._PmCaptureL7Conversations.ReserveMessage(messageHeader, target); }
        public void ReleaseReservation(DataflowMessageHeader messageHeader, ITargetBlock<PmCaptureL7Conversation> target) { this._PmCaptureL7Conversations.ReleaseReservation(messageHeader, target); }
        #endregion
