...
namespace Netfox.Framework.CaptureProcessor.L7PDUTracking.DVB
{
    ...
    class ModeAdaptationHeaderL3
    {
        ...
        public static ModeAdaptationHeaderL3 Parse(PDUStreamReader reader)
        {
            ...
            if(b != Sync) { throw new InvalidPacketFormatException($"SYNC byte mismatch at byte 0. {b}!={Sync}"); }
            ...
            if((b&0b1000_0000) != 0) { throw new InvalidPacketFormatException($"Unexpected bit 1 at byte 1, bit 7."); }
