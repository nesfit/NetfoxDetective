...
namespace PacketDotNet.MiscUtil.IO
{
    ...
    public class EndianBinaryWriter : IDisposable
    {
        ...
        public EndianBinaryWriter(EndianBitConverter bitConverter, Stream stream, Encoding encoding)
        {
            ...
            if(!stream.CanWrite) { throw new ArgumentException("Stream isn't writable", "stream"); }
        ...
        /// </summary>
        private void CheckDisposed() { if(this.disposed) { throw new ObjectDisposedException("EndianBinaryWriter"); } }
