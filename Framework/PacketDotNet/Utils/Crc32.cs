...
namespace PacketDotNet.Utils
{
    ...
    public class Crc32 : HashAlgorithm
    {
        ...
        public new byte[] ComputeHash(Stream inputStream)
        {
            ...
            int bytesRead;
            while((bytesRead = inputStream.Read(buffer, 0, 4096)) > 0) { this.HashCore(buffer, 0, bytesRead); }
        ...
        ///     data.
        /// </remarks>
        public new byte[] ComputeHash(byte[] buffer) { return this.ComputeHash(buffer, 0, buffer.Length); }
        ...
        public override sealed void Initialize() { this._crc = _allOnes; }
        ...
        private static int ToInt32(byte[] buffer) { return BitConverter.ToInt32(buffer, 0); }
