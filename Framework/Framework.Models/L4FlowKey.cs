...
namespace Netfox.Framework.Models
{
    ...
    public class L4FlowKey
    {
        ...
        ///     .
        /// </returns>
        public override String ToString() => String.Format("{0}:{1}<->{2}", this.L4ProtocolType, this.EndPoints[0], this.EndPoints[1]);
        ...
        /// </returns>
        public override Int32 GetHashCode() => (this.EndPoints[0] ?? PmFrameBase.NullEndPoint).GetHashCode() ^ (this.EndPoints[1] ?? PmFrameBase.NullEndPoint).GetHashCode() ^ this.L4ProtocolType.GetHashCode();
