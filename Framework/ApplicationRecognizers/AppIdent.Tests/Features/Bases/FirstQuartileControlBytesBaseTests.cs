...
{
    [TestFixture]
    public class FirstQuartileBytesBaseTests : FeatureBaseTests<FirstQuartileControlBytesBase>
    {
        [Test]
        ...
        #region Overrides of FeatureBaseTests<FirstQuartileControlBytesBase>
