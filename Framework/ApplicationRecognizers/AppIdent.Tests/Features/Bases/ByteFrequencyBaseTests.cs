...
{
    [TestFixture]
    public class ByteFrequencyBaseTests : FeatureBaseTests<ByteFrequencyBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.038453620757743764);
        }
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.020824828195876072);
