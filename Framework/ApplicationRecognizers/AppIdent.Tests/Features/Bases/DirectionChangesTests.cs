...
{
    [TestFixture]
    public class DirectionChangesTests : FeatureBaseTests<DirectionChanges>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 28.0d);
        }

        #region Overrides of FeatureBaseTests<DirectionChanges>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 28.0d);
        }
