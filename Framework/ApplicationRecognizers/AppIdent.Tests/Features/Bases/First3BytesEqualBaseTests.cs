...
{
    [TestFixture]
    public class First3BytesEqualBaseTests : FeatureBaseTests<First3BytesEqualBase>
    {
        [Test]
        ...
        #region Overrides of FeatureBaseTests<First3BytesEqualBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.0d);
