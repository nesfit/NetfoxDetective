...
{
    [TestFixture]
    public class PUSHPacketsBaseTests : FeatureBaseTests<PUSHPacketsBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 17.0d);
        }
        ...
        {   
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 18.0d);
        }
