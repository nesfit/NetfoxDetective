...
{
    [TestFixture]
    public class NumberOfPacketsPerTimeTests : FeatureBaseTests<NumberOfPacketsPerTime>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.4165570169279373d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 2.5975429840913482d);
        }

        #region Overrides of FeatureBaseTests<NumberOfPacketsPerTime>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 3.2968814798082495d);
        }
