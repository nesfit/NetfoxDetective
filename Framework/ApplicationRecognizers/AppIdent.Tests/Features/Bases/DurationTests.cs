...
{
    [TestFixture]
    public class DurationTests : FeatureBaseTests<Duration>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(0.050012752059974686d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 9.9763819999999992d);
        }

        #region Overrides of FeatureBaseTests<Duration>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 9.9763819999999992d);
            Console.WriteLine("Feature Value: {0}",feature.FeatureValue);
