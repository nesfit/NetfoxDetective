...
{
    [TestFixture]
    public class FirstQuartileInterArrivalTimeBaseTests : FeatureBaseTests<FirstQuartileInterArrivalTimeBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        { 
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(5.3713587487781096d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 0.019032d);
        }

        #region Overrides of FeatureBaseTests<FirstQuartileInterArrivalTimeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 0.014789999999999999d);
        }
