...
{
    [TestFixture]
    public class MaxPacketLengthBaseTests : FeatureBaseTests<MaxPacketLengthBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 1500.0d);
        }
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 1144.0d);
        }
