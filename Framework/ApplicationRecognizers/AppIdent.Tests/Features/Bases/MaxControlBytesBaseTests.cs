...
{
    [TestFixture]
    public class MaxControlBytesBaseTests : FeatureBaseTests<MaxControlBytesBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 28);
        }
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 28);
        }
