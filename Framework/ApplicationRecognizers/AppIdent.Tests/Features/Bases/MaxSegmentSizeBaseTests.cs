...
{
    [TestFixture]
    public class MaxSegmentSizeBaseTests : FeatureBaseTests<MaxSegmentSizeBase>
    {
        [Test]
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 1460.0d);
        }

        #region Overrides of FeatureBaseTests<MaxSegmentSizeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 1104.0d);
