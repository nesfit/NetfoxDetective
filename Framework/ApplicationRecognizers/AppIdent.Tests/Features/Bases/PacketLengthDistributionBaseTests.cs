...
{
    [TestFixture]
    public class PacketLengthDistributionBaseTests : FeatureBaseTests<PacketLengthDistributionBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        { 
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.4941900916247621d);
        }

        [Test]
        public override void ComputeFeature_FeatureValueDownFlow_ExpectedFeatureValue()
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.down, 367.11538025823063d);
        }

        #region Overrides of FeatureBaseTests<PacketLengthDistributionBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 242.46807095388615d);
