...
{
    [TestFixture]
    public class MaxInterArrivalTimeBaseTests : FeatureBaseTests<MaxInterArrivalTimeBase>
    {
        [Test]
        public override void ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_ExpectedDistance()
        {
            this.ComputeDistanceToProtocolModelTest_TrainingToTesingDistance_NotZero(2.8041801378729043d);
        }
        ...
        #region Overrides of FeatureBaseTests<MaxInterArrivalTimeBase>
        ...
        {
            var feature = this.ComputeFeature_FeatureValue_ExpectedFeatureValue(DaRFlowDirection.up, 4.772532d);
