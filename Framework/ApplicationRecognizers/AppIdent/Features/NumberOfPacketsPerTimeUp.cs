...
{
    public class NumberOfPacketsPerTimeUp : NumberOfPacketsPerTime
    {
        public NumberOfPacketsPerTimeUp() { }
        public NumberOfPacketsPerTimeUp(L7Conversation l7Conversation) : base(l7Conversation, DaRFlowDirection.up) { }
        public NumberOfPacketsPerTimeUp(double featureValue) : base(featureValue) { }
    }
}