...
{
    public class MinControlBytesUpAndDown : MinControlBytesBase
    {
        public MinControlBytesUpAndDown() { }
        public MinControlBytesUpAndDown(L7Conversation l7Conversation) : base(l7Conversation, DaRFlowDirection.non) { }
        public MinControlBytesUpAndDown(double featureValue) : base(featureValue) { }
    }
}