...
{
    public class MedianControlBytesBase : FeatureBase
    {
        public MedianControlBytesBase() { }
        public MedianControlBytesBase(L7Conversation l7Conversation, DaRFlowDirection flowDirection) : base(l7Conversation, flowDirection) { }
        public MedianControlBytesBase(double featureValue) : base(featureValue) { }
