...
{
    public class FirstQuartileInterArrivalTimeBase : FeatureBase
    {
        public FirstQuartileInterArrivalTimeBase() { }
        ...
        public FirstQuartileInterArrivalTimeBase(double featureValue) : base(featureValue) { }
        ...
        public override double ComputeFeature(L7Conversation l7Conversation, DaRFlowDirection flowDirection)
        {
            ...
            for(var i = 0; i < length - 1; i++) { times[i] = Math.Abs((l7Pdus[i + 1].FirstSeen - l7Pdus[i].FirstSeen).TotalSeconds); }
