...
namespace Netfox.Framework.Models
{
    ...
    public abstract class ConversationStatisticsBase :  ILxConversationStatistics
    {
        ...
        [NotMapped]
        public virtual ConversationStatisticsBase DownFlowStatistic { get; protected set; }

        [NotMapped]
        public virtual ConversationStatisticsBase UPFlowStatistic { get; protected set; }
        ...
        public virtual void ProcessFrame(PmFrameBase frame)
        {
            ...
            if (frame.TimeStamp < this.FirstSeen) { this.FirstSeen = frame.TimeStamp; }
            if (frame.TimeStamp > this.LastSeen) { this.LastSeen = frame.TimeStamp; }
        }
        ...
        public Int64 Bytes
        {
            get { return (uint) (this._bytes ?? (this._bytes = this.UPFlowStatistic.Bytes + this.DownFlowStatistic.Bytes)); }
        ...
        public  DateTime FirstSeen
        {
            get
            {
                ...
                if (this.UPFlowStatistic != null && this.DownFlowStatistic != null)
                {
                    return
                    (this._firstSeen =
                        (this.UPFlowStatistic.FirstSeen < this.DownFlowStatistic.FirstSeen) ? this.UPFlowStatistic.FirstSeen : this.DownFlowStatistic.FirstSeen);
                }
                this._firstSeen = this.UPFlowStatistic?.FirstSeen ?? this.DownFlowStatistic?.FirstSeen  ?? DateTime.MinValue;
                return this._firstSeen;
            }
        ...
        public Int64 Frames
        {
            get { return (uint) (this._frames ??(this._frames =this.UPFlowStatistic.Frames + this.DownFlowStatistic.Frames)); }
        ...
        public  DateTime LastSeen
        {
            get
            {
                ...
                if (this.UPFlowStatistic != null && this.DownFlowStatistic != null)
                {
                    return (this._lastSeen = (this.UPFlowStatistic.LastSeen > this.DownFlowStatistic.LastSeen) ? this.UPFlowStatistic.LastSeen : this.DownFlowStatistic.LastSeen);
                }
                this._lastSeen = this.UPFlowStatistic?.LastSeen ?? this.DownFlowStatistic?.LastSeen ?? DateTime.MaxValue;
                return this._lastSeen;
            }
        ...
        {
            get { return (uint) (this._malformedFrames ?? (this._malformedFrames = this.UPFlowStatistic.MalformedFrames + this.DownFlowStatistic.MalformedFrames)) ; }
