...
#pragma warning restore 0169, 0649
        ...
        ///     origin of the LLDP
        /// </param>
        public SystemDescription(byte[] bytes, int offset) : base(bytes, offset) { log.Debug(""); }
        ...
        /// </param>
        public SystemDescription(string description) : base(TLVTypes.SystemDescription, description) { log.Debug(""); }
        #endregion
