...
#pragma warning restore 0169, 0649
        ...
        public virtual PhysicalAddress SourceHwAddress
        {
            get
            {
                ...
                Array.Copy(this.header.Bytes, this.header.Offset + EthernetFields.SourceMacPosition, hwAddress, 0, hwAddress.Length);
            ...
            set
            {
                ...
                Array.Copy(hwAddress, 0, this.header.Bytes, this.header.Offset + EthernetFields.SourceMacPosition, hwAddress.Length);
            }
        }
        ...
        public virtual PhysicalAddress DestinationHwAddress
        {
            ...
            {
                var hwAddress = new byte[EthernetFields.MacAddressLength];
                Array.Copy(this.header.Bytes, this.header.Offset + EthernetFields.DestinationMacPosition, hwAddress, 0, hwAddress.Length);
                return new PhysicalAddress(hwAddress);
            }
            ...
            set
            {
                ...
                Array.Copy(hwAddress, 0, this.header.Bytes, this.header.Offset + EthernetFields.DestinationMacPosition, hwAddress.Length);
            }
        }
        ...
        {
            get { return (EthernetPacketType) EndianBitConverter.Big.ToInt16(this.header.Bytes, this.header.Offset + EthernetFields.TypePosition); }
        ...
        /// </returns>
        internal static PacketOrByteArraySegment ParseEncapsulatedBytes(ByteArraySegment Header, EthernetPacketType Type)
        {
        ...
        public static EthernetPacket GetEncapsulated(Packet p)
        {
            ...
            if(p is EthernetPacket) { return (EthernetPacket) p; }
        ...
        public override string ToString(StringOutputType outputFormat)
        {
            ...
            if(outputFormat == StringOutputType.Normal || outputFormat == StringOutputType.Colored)
            {
                ...
                buffer.AppendFormat("{0}[EthernetPacket: SourceHwAddress={2}, DestinationHwAddress={3}, Type={4}]{1}", color, colorEscape,
                    HexPrinter.PrintMACAddress(this.SourceHwAddress), HexPrinter.PrintMACAddress(this.DestinationHwAddress), this.Type);
            }
            ...
            if(outputFormat == StringOutputType.Verbose || outputFormat == StringOutputType.VerboseColored)
            {
                ...
                foreach(var property in properties) { buffer.AppendLine("Eth: " + property.Key.PadLeft(padLength) + " = " + property.Value); }
                buffer.AppendLine("Eth:");
            }
        ...
        public static EthernetPacket RandomPacket()
        {
            ...
            return new EthernetPacket(new PhysicalAddress(srcPhysicalAddress), new PhysicalAddress(dstPhysicalAddress), EthernetPacketType.None);
        }
    }
}