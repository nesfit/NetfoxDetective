...
#pragma warning restore 0169, 0649
            ...
            private int GetOffsetForAddress(int addressIndex)
            {
                ...
                // field
                if(addressIndex == 4) { offset += MacFields.SequenceControlLength; }
            ...
            protected void SetAddressByOffset(int offset, PhysicalAddress address)
            {
                ...
                Array.Copy(hwAddress, 0, this.header.Bytes, offset, hwAddress.Length);
            }
            ...
            protected PhysicalAddress GetAddressByOffset(int offset)
            {
                if((this.header.Offset + this.header.Length) >= (offset + MacFields.AddressLength))
                {
                    ...
                    Array.Copy(this.header.Bytes, offset, hwAddress, 0, hwAddress.Length);
            ...
            {
                var payloadLength = this.header.BytesLength - (this.header.Offset + this.FrameSize);
            ...
            public static MacFrame ParsePacketWithFcs(ByteArraySegment bas)
            {
                ...
                var basWithoutFcs = new ByteArraySegment(bas.Bytes, bas.Offset, bas.Length - MacFields.FrameCheckSequenceLength,
                    bas.BytesLength - MacFields.FrameCheckSequenceLength);

                var fcs = EndianBitConverter.Big.ToUInt32(bas.Bytes, (bas.Offset + bas.Length) - MacFields.FrameCheckSequenceLength);
            ...
            public static MacFrame ParsePacket(ByteArraySegment bas)
            {
                ...
                var frameControl = new FrameControlField(EndianBitConverter.Big.ToUInt16(bas.Bytes, bas.Offset));
            ...
            public override ByteArraySegment BytesHighPerformance
            {
                get
                {
                       ...
                       && ((!this.AppendFcs) || (this.header.Bytes.Length >= (this.header.Offset + totalPacketLength + MacFields.FrameCheckSequenceLength))))
                    {
                        ...
                        var newByteArraySegment = new ByteArraySegment(this.header.Bytes, this.header.Offset, packetLength);
            ...
            {
                return string.Format("802.11 MacFrame: [{0}], {1} FCS {2}", this.FrameControl, this.GetAddressString(), this.FrameCheckSequence);
            }
