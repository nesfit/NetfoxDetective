...
namespace EntityFramework.BulkInsert.Extensions
{
    public static class BulkInsertExtension
    {
        ...
        public static async Task BulkInsertBuffered<T>(this DbContext context, IEnumerable<T> entities, int? batchSize = null)
        {
           await context.BulkInsertBuffered(entities, SqlBulkCopyOptions.Default, batchSize);
        }


        public static async Task BulkInsertBuffered<T>(this DbContext context, IEnumerable<T> entities, SqlBulkCopyOptions sqlBulkCopyOptions, int? batchSize = null)
        {
        ...
        public static async Task BulkInsertBuffered<T>(this DbContext context, IEnumerable<T> entities, IDbTransaction transaction, SqlBulkCopyOptions sqlBulkCopyOptions = SqlBulkCopyOptions.Default, int? batchSize = null)
        {
            var options = new BulkInsertOptions { SqlBulkCopyOptions = sqlBulkCopyOptions };
            if (batchSize.HasValue)
            {
