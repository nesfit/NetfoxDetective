...
{
    [TestFixture()]
    public class VirtualizingObservableCollectionConcurrencyTests : ConcurrencyTestsBase
    {
        [Test]
        public void VirtualizingObservableCollection()
        {
            var currentMethodName = this.GetCurrentMethodName();
            var collection = new VirtualizingObservableCollection<Item>(new VirtualizingObservableCollectionSource<Item>());
        ...
        [Test]
        public void VirtualizingObservableCollectionConcurrentReadAndRemove()
        {
            var currentMethodName = this.GetCurrentMethodName();
            var collection = new VirtualizingObservableCollection<Item>(new VirtualizingObservableCollectionSource<Item>());
