            ...
            if (this.Filters != null)
            {
                ...
                if (!String.IsNullOrEmpty(this.Filters.SearchText))
                {
                    ...
                    if (count == 0)
                    {
                        ...
                        if (this.Filters.SearchText.Count(f => f == '.') > 0)
                        {
                            ...
                            if (success)
                            {
                                ...
                                query = query.Where(c => c.SourceEndPointIPAddressData == addressBytes || c.DestinationEndPointIPAddressData == addressBytes);
                            }
                        }
                        else // port
                        {
                            ...
                            if (success)
                            {
                                query = query.Where(c => c.SourceEndPointPort == port || c.DestinationEndPointPort == port);
                            }
                        }
                    ...
                    else if (count == 1) //IPEndpoint
                    {
                        ...
                        query = query.Where(c => (c.SourceEndPointIPAddressData == searchTextBytes && c.SourceEndPointPort == port) || (c.DestinationEndPointIPAddressData == searchTextBytes && c.DestinationEndPointPort == port));
                    }
                    else //IPv6Endpoint
                    {
                        ...
                        if (splitEndpoint.Count() > 1)
                        {
                            ...
                            var port = Int64.Parse(splitEndpoint[1]);
                            query = query.Where(c => (c.SourceEndPointIPAddressData == addressBytes && c.SourceEndPointPort == port) || (c.DestinationEndPointIPAddressData == addressBytes && c.DestinationEndPointPort == port));
