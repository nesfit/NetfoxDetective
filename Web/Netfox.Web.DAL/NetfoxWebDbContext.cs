    ...
    public class NetfoxWebDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            /*modelBuilder.Entity<User>()
                .HasMany<Investigation>(x => x.Investigations)
                .WithMany(x => x.Investigators)
                .Map(x =>
                {
                    x.MapLeftKey(nameof(UserInvestigation.UserId));
                    x.MapRightKey(nameof(UserInvestigation.InvestigationId));
                    x.ToTable(typeof(UserInvestigation).Name);
                });*/
