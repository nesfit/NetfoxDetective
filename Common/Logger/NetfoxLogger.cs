...
namespace Netfox.Logger
{
    ...
    public class NetfoxLogger : ILogger, IDisposable
    {
        ...
        public void DebugFormat(Exception exception, string format, params object[] args) { this.Logger?.DebugFormat(exception, format, args); }
        public void DebugFormat(IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.DebugFormat(formatProvider, format, args); }
        public void DebugFormat(Exception exception, IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.DebugFormat(exception, formatProvider, format, args); }
        public void Error(string message) { this.Logger?.Error(message); }
        public void Error(Func<string> messageFactory) { this.Logger?.Error(messageFactory); }
        ...
        public void ErrorFormat(Exception exception, string format, params object[] args) { this.Logger?.ErrorFormat(exception, format, args); }
        public void ErrorFormat(IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.ErrorFormat(formatProvider, format, args); }
        public void ErrorFormat(Exception exception, IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.ErrorFormat(exception, formatProvider, format, args); }
        public void Fatal(string message) { this.Logger?.Fatal(message); }
        public void Fatal(Func<string> messageFactory) { this.Logger?.Fatal(messageFactory); }
        ...
        public void FatalFormat(Exception exception, string format, params object[] args) { this.Logger?.FatalFormat(exception, format, args); }
        public void FatalFormat(IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.FatalFormat(formatProvider, format, args); }
        public void FatalFormat(Exception exception, IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.FatalFormat(exception, formatProvider, format, args); }
        public void Info(string message) { this.Logger?.Info(message); }
        public void Info(Func<string> messageFactory) { this.Logger?.Info(messageFactory); }
        public void Info(string message, Exception exception) { this.Logger?.Info(message, exception); }
        public void InfoFormat(string format, params object[] args) { this.Logger?.InfoFormat(format, args); }
        public void InfoFormat(Exception exception, string format, params object[] args) { this.Logger?.InfoFormat(exception, format, args); }
        public void InfoFormat(IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.InfoFormat(formatProvider, format, args); }
        public void InfoFormat(Exception exception, IFormatProvider formatProvider, string format, params object[] args) { this.Logger?.InfoFormat(exception, formatProvider, format, args); }
        public void Warn(string message) { this.Logger?.Warn(message); }
        public void Warn(Func<string> messageFactory) { this.Logger?.Warn(messageFactory); }
        public void Warn(string message, Exception exception) { this.Logger?.Warn(message, exception); }
