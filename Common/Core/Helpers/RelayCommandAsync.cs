...
namespace Netfox.Core.Helpers
{
    public class RelayCommandAsync : CommandBase
    {
        ...
        ///     be set to null.
        /// </param>
        public override bool CanExecute(object parameter = null) => this._canExecute() && !this.CancelCommandInternal.CommandExecuting;

        public sealed override async void Execute(object parameter = null)
        {
            try { await this.ExecuteAsync(parameter); }
            catch(Exception)
            {
        ...
        protected virtual void AssignExecution(object parameter)
        {
            ...
            else if(this._commandCancellable != null) this.Execution = new NotifyTaskCompletion(this._commandCancellable(this.CancelCommandInternal.Token),this.RaiseCanExecuteChanged);
        }

        protected virtual async Task ExecuteTask(object parameter) { await this.Execution; }
        ...
        protected sealed class CancelAsyncCommand : CommandBase
        {
            ...
            public override bool CanExecute(object parameter) { return this.CommandExecuting && !this._cts.IsCancellationRequested; }
    ...
    public class RelayCommandAsync<TResult> : RelayCommandAsync where TResult : class
    {
        ...
        public RelayCommandAsync(Func<TResult, CancellationToken, Task> commandParrametrized, Func<object, bool> canExecute)
        {
            this._canExecute = canExecute;
        ...
        {
            base.Execution = new NotifyTaskCompletion(this._commandParrametrized(parameter as TResult,this.CancelCommandInternal.Token), this.RaiseCanExecuteChanged);
        }


        public override bool CanExecute(object parameter = null) { return this._canExecute(parameter) && !this.CancelCommandInternal.CommandExecuting; }
