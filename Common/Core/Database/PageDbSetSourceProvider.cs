...
{
    public class PageDbSetSourceProvider<T> : INotifyImmediately, IPagedSourceObservableProvider<T> where T : class, IEntity
    {
        ...
        public bool Contains(T item) { return this.ObservableDbSetRepository.Contains(item); }
        #endregion
        ...
        //{
        //    return this.ObservableDbSetRepository.GetEnumerator(); 
        //}
        #endregion
        ...
        public void CopyTo(Array array, int index) { Debugger.Break(); }

        int IPagedSourceProvider<T>.Count => this.ObservableDbSetRepository.Count;
        public int IndexOf(T item) {return this.ObservableDbSetRepository.IndexOf(item);
        }
